...
{
  public:
	  typedef FastDelegate0<void> cb_fn;
    ModbusMaster();
   
    void begin(uint8_t, Stream &serial);
    void idle(cb_fn idle_fn);
    void preTransmission(cb_fn pre_fn);
    void postTransmission(cb_fn post_fn);
  ...
  private:
    ...
    // preTransmission callback function; gets called before writing a Modbus message
	  cb_fn _preTransmission;
    // postTransmission callback function; gets called after a Modbus message has been sent
	  cb_fn _postTransmission;
};
#endif
